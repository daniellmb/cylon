...
Cylon.start = function start() {
  ...
  for (var bot in this.robots) {
    starters.push(this.robots[bot].start.bind(this.robot));
  }
...
Cylon.halt = function halt(callback) {
  ...
  for (var bot in this.robots) {
    fns.push(this.robots[bot].halt.bind(this.robots[bot]));
  }
...
Cylon.toJSON = function() {
  ...
  for (var bot in this.robots) {
    bots.push(this.robots[bot].toJSON());
  }
